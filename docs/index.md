...
heroText: 花开不停
tagline: 晓看天色暮看云，行也思君，坐也思君
# actionText: 立刻进入 →
# actionLink: /ops/
bannerBg: /img/yun1.jpg # auto => 网格纹背景(有bodyBgImg时无背景)，默认 | none => 无 | '大图地址' | background: 自定义背景样式       提示：如发现文本颜色不适应你的背景时可以到palette.styl修改$bannerTextColor变量
