...
module.exports = {
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/weichao009',
      },
      {
        iconClass: 'icon-youjian',
        title: '发邮件',
        link: 'mailto:15235969160@163.com',
      },
      {
        iconClass: 'icon-rss',
        title: '订阅',
  ...
  footer: {
    ...
    copyrightInfo:
    '| <a rel="nofollow " target="_blank" href="https://beian.miit.gov.cn/">京ICP备2023013437号</a>',
